...
# #     statut_monnaie = models.CharField(max_length=20, choices=[("remis","Remis"),("avoir","Avoir")], default="remis")

# #     @property
# #     def montant_total(self):
# #         # Somme des montants de chaque boisson
# #         total = sum([item.montant_boisson for item in self.items.all()])
# #         return total

# #     def __str__(self):
# #         return f"Commande {self.id} - {self.personnel.username} - {self.montant_total}"
...
#     # Montant total stocké (calculé automatiquement)
